    ...
    return (
        <section className="max-w-7xl mx-auto px-6 mt-4 mb-4">
            <div className="text-center mb-10">
                <h1 className="text-4xl font-bold text-[#799AA3]">Get in Touch with Us!</h1>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-8 items-center">
                <div>
                    ...
                    <a href="https://wa.me/+919890533525" className="inline-flex items-center px-4 py-2 bg-[#455A64] text-white font-medium rounded hover:bg-[#3a5662] focus:outline-none">
                ...
                <div className="flex items-center justify-center">
                    <img src={contactImg} alt="Global Exports and Logistics" className="rounded-lg shadow-lg w-full" />
                </div>
            </div>
                        ...
                        <div className="flex flex-col gap-16">
                            ...
                            <div className="grid w-full grid-cols-2 gap-x-5 gap-y-16">
                                <div className="flex flex-col items-center gap-3 text-center md:text-start md:items-start">
                                    ...
                                    <a className="text-lg font-bold text-gray-600" href="mailto: locoprivatesolutions@gmail.com">locoprivatesolutions@gmail.com</a>
                                </div>
                                <div className="flex flex-col items-center gap-3 text-center md:text-start md:items-start">
                                    <span>
                                        <svg xmlns="http://www.w3.org/2000/svg" width="24" height="25" viewBox="0 0 24 25" fill="none">
                        ...
                        <div className="flex flex-col gap-5 p-6 bg-white rounded-3xl shadow-main md:p-10">
                            ...
                            <form className="flex flex-col gap-6">
                                <label className="flex flex-col gap-2 text-sm font-medium text-dark-grey-600">
                                    Full Name
                                    <input className="p-4 border border-solid outline-none rounded-xl placeholder:text-sm placeholder:font-medium placeholder:text-dark-grey-500 border-grey-300 focus:border-grey-600 focus:ring-2 focus:ring-grey-600 bg-white" placeholder="Your full name" type="text" id="full-name" required />
                                </label>
                                <label className="flex flex-col gap-2 text-sm font-medium text-dark-grey-600">
                                    Your Email
                                    <input className="p-4 border border-solid outline-none rounded-xl placeholder:text-sm placeholder:font-medium placeholder:text-dark-grey-500 border-grey-300 focus:border-grey-600 focus:ring-2 focus:ring-grey-600 bg-white" placeholder="Your email address" type="text" id="email" required />
                                </label>
                                <label className="flex flex-col gap-2 text-sm font-medium text-dark-grey-600">
                                    Message
                                    <textarea className="p-4 border border-solid outline-none rounded-xl placeholder:text-sm placeholder:font-medium placeholder:text-dark-grey-500 border-grey-300 focus:border-grey-600 focus:ring-2 focus:ring-grey-600 bg-white" placeholder="Your message" id="message" required></textarea>
                                </label>
                                <button type="submit" className="flex items-center justify-center py-4 text-center text-white px-7 rounded-2xl bg-[#455A64] hover:bg-[#3a5662] focus:ring-4 focus:ring-purple-blue-100 transition duration-300">Submit message</button>
                            </form>
                        </div>
                    </div>
                </div>
