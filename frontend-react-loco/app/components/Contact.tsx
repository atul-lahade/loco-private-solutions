                    ...
                    <div className="grid items-center grid-cols-1 gap-4 lg:grid-cols-2">
                        <div className="flex flex-col gap-16">
                            <div className="flex flex-col w-10/12 gap-2 text-center mx-auto md:text-start md:ml-0">
                                <h3 className="text-4xl font-extrabold text-[#799AA3] font-display">{t("contact.contact_us")}</h3>
                            ...
                            <div className="grid w-full grid-cols-2 gap-24">
                                <div className="flex flex-col items-center gap-3 text-center md:text-start md:items-start">
                                    ...
                                    <h3 className="text-2xl font-extrabold text-[#799AA3] font-display">{t("contact.email")}</h3>
                                ...
                                <div className="flex flex-col items-center gap-3 text-center md:text-start md:items-start">
                                    ...
                                    <h3 className="text-2xl font-extrabold text-[#799AA3] font-display">{t("contact.phone")}</h3>
                                ...
                                <div className="flex flex-col items-center gap-3 text-center md:text-start md:items-start">
                                    ...
                                    <h3 className="text-2xl font-extrabold text-[#799AA3] font-display">{t("contact.location")}</h3>
                                ...
                                <div className="flex flex-col items-center gap-3 text-center md:text-start md:items-start">
                                    ...
                                    <h3 className="text-2xl font-extrabold text-[#799AA3] font-display">{t("contact.hrs")}</h3>
