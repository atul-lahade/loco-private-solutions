    ...
    return (
        <section className="max-w-7xl mx-auto px-16 mt-16">
            <div className="text-center my-10 px-4 md:px-0">
                <h1 className="text-3xl md:text-4xl font-bold text-[#799AA3]">Get in Touch with Us!</h1>
                <div className="mt-4 flex justify-center">
                    <hr aria-hidden="true" role="separator" className="border-t-2 border-gray-300 w-1/3 md:w-1/6" />
                </div>
            </div>
            <div className="grid grid-cols-1 md:grid-cols-2 gap-8 items-center">
                <div>
                    <h2 className="text-4xl font-semibold text-[#799AA3] mb-4">Better yet, see us in person!</h2>
                    <p className="text-gray-600 mb-6 leading-relaxed text-md">
                        We're here to help you find the perfect products for your needs. Whether you have a question about our <span className="font-semibold">export offerings</span> or need assistance, we're just a message away. Reach out today, and let's explore how we can work together for your success!
                    </p>
                    ...
                    <div className="mt-8  leading-relaxed tracking-wide">
                        <h3 className="font-semibold text-lg text-[#799AA3]">Loco Private Solutions</h3>
                        <span className="text-black flex items-center">Govind Nagar, Nashik, Maharashtra, <img className="h-4 w-4 ml-1 mr-1" src={indFlag} alt="India Flag" /> India</span>
                        ...
                        <div className="flex flex-col gap-16">
                            ...
                            <div className="grid w-full grid-cols-2 gap-24">
                                ...
                                <div className="flex flex-col items-center gap-3 text-center md:text-start md:items-start">
                                    ...
                                    <h3 className="text-2xl font-extrabold text-[#799AA3] font-display">Phone</h3>
                                    <a className="text-lg font-bold text-gray-600" href="tel:+919890533525">+91 9890533525</a>
                                </div>
                                <div className="flex flex-col items-center gap-3 text-center md:text-start md:items-start">
                                    <span>
                                        <svg xmlns="http://www.w3.org/2000/svg" width="24" height="25" viewBox="0 0 24 25" fill="none">
                                    ...
                                    <h3 className="text-2xl font-extrabold text-[#799AA3] font-display">Location</h3>
                                    <a className="text-lg font-bold text-gray-600" target="_blank" href="https://maps.app.goo.gl/jrTyFCnnnYuM4BCq9">Nashik, MH, India 422009</a>
                                </div>
                                <div className="flex flex-col items-center gap-3 text-center md:text-start md:items-start">
                                    <span>
                                        <svg xmlns="http://www.w3.org/2000/svg" width="24" height="25" viewBox="0 0 24 25" fill="none">
                                    ...
                                    <h3 className="text-2xl font-extrabold text-[#799AA3] font-display">Working Hours</h3>
                                    <a className="text-lg font-bold text-gray-600" target="_blank">09:00 AM-06:00 PM</a>
                                </div>
                            </div>
                        </div>
