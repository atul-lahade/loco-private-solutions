    ...
    return (
        <section className="max-w-7xl mx-auto px-16 mt-16">
            <div className="text-center my-10 px-4 md:px-0">
                <h1 className="text-3xl md:text-4xl font-bold text-[#799AA3]">{t("contact.heading")}</h1>
                    ...
                    <div className="grid items-center grid-cols-1 gap-4 lg:grid-cols-2">
                        <div className="flex flex-col gap-16">
                            <div className="flex flex-col w-10/12 gap-2 text-center mx-auto md:text-start md:ml-0">
                                <h3 className="text-4xl font-bold text-[#799AA3] font-display">{t("contact.contact_us")}</h3>
                                <p className="text-base font-medium leading-7 text-gray-600">{t("contact.contact_us_desc")}</p>
                            </div>
                            <div className="grid w-full grid-cols-2 gap-24">
                                <div className="flex flex-col items-center gap-3 text-center md:text-start md:items-start">
                                    ...
                                    <h3 className="text-2xl font-bold text-[#799AA3] font-display">{t("contact.email")}</h3>
                                ...
                                <div className="flex flex-col items-center gap-3 text-center md:text-start md:items-start">
                                    ...
                                    <h3 className="text-2xl font-bold text-[#799AA3] font-display">{t("contact.phone")}</h3>
                                ...
                                <div className="flex flex-col items-center gap-3 text-center md:text-start md:items-start">
                                    ...
                                    <h3 className="text-2xl font-bold text-[#799AA3] font-display">{t("contact.location")}</h3>
                                ...
                                <div className="flex flex-col items-center gap-3 text-center md:text-start md:items-start">
                                    ...
                                    <h3 className="text-2xl font-bold text-[#799AA3] font-display">{t("contact.hrs")}</h3>
                        ...
                        <div className="flex flex-col gap-5 p-6 bg-white rounded-3xl shadow-main md:p-10">
                            <h3 className="text-4xl font-bold text-dark-grey-900 font-display  text-[#799AA3] font-display">{t("contact.form.heading")}</h3>
