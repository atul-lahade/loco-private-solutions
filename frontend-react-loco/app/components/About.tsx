                    ...
                    <div className="w-full justify-start items-center gap-8 grid lg:grid-cols-2 grid-cols-1">
                        <div className="w-full flex-col justify-start lg:items-start items-center gap-10 inline-flex">
                            <div className="w-full flex-col justify-start lg:items-start items-center gap-2 flex">
                                <h2 className="text-[#40545a] text-4xl font-bold font-manrope leading-normal lg:text-start text-center">{t("about.heading")}</h2>
                    ...
                    <div className="grid lg:grid-cols-2 grid-cols-1 gap-8 px-8">
                        <div className="flex flex-row items-center lg:items-start gap-4">
                            ...
                            <div className="text-center lg:text-left">
                                <h3 className="text-2xl font-bold text-[#40545a] mb-3">{t("about.mission_heading")}</h3>
                                <p className="text-gray-500 text-base leading-relaxed">{t("about.mission_desc")}</p>
                            </div>
                        </div>
                        <div className="flex flex-row items-center lg:items-start gap-4">
                            ...
                            <div className="text-center lg:text-left">
                                <h3 className="text-2xl font-bold text-[#40545a] mb-3">{t("about.vision_heading")}</h3>
                                <p className="text-gray-500 text-base leading-relaxed">{t("about.vision_desc")}</p>
                            </div>
                        </div>
                    </div>
                </div>
            ...
            <section className="bg-gradient-to-br from-[#FFFEFF] to-gray-300">
                <div className="container mx-auto p-6 md:p-12 mt-6">
                    <div className="text-center pt-6 mb-12">
                        ...
                        <h2 className="text-3xl md:text-4xl font-bold text-[#40545a]">{t("about.values.heading")}</h2>
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6 md:gap-8">
                        ...
                        <div className="flex flex-col items-center text-center p-4 md:p-6 bg-white rounded-lg shadow-md">
                            ...
                            <h4 className="text-xl md:text-2xl font-bold mb-3 text-[#40545a]">{t("about.values.value_2.heading")}</h4>
                            <p className="text-gray-500 text-sm md:text-base"><strong><em>{t("about.values.value_2.slogan")}<br /></em></strong>{t("about.values.value_2.desc")}</p>
                        </div>
                        <div className="flex flex-col items-center text-center p-4 md:p-6 bg-white rounded-lg shadow-md">
                            <img className="mx-2 my-2 w-12 h-12 md:w-14 md:h-14" src={certifiedImg} alt="Certified Services" />
                            <h4 className="text-xl md:text-2xl font-bold mb-3 text-[#40545a]">{t("about.values.value_3.heading")}</h4>
                            <p className="text-gray-500 text-sm md:text-base"><strong><em>{t("about.values.value_3.slogan")}<br /></em></strong>{t("about.values.value_3.desc")}</p>
                        </div>
                        <div className="flex flex-col items-center text-center p-4 md:p-6 bg-white rounded-lg shadow-md">
                            <img className="mx-2 my-2 w-12 h-12 md:w-14 md:h-14" src={commitmentImg} alt="Commitment" />
                            <h4 className="text-xl md:text-2xl font-bold mb-3 text-[#40545a]">{t("about.values.value_4.heading")}</h4>
                            <p className="text-gray-500 text-sm md:text-base"><strong><em>{t("about.values.value_4.slogan")}<br /></em></strong>{t("about.values.value_4.desc")}</p>
                        </div>
                        <div className="flex flex-col items-center text-center p-4 md:p-6 bg-white rounded-lg shadow-md">
                            <img className="mx-2 my-2 w-12 h-12 md:w-14 md:h-14" src={innovationImg} alt="Innovation" />
                            <h4 className="text-xl md:text-2xl font-bold mb-3 text-[#40545a]">{t("about.values.value_5.heading")}</h4>
                            <p className="text-gray-500 text-sm md:text-base"><strong><em>{t("about.values.value_5.slogan")}<br /></em></strong>{t("about.values.value_5.desc")}</p>
                        </div>
                        <div className="flex flex-col items-center text-center p-4 md:p-6 bg-white rounded-lg shadow-md">
                            <img className="mx-2 my-2 w-12 h-12 md:w-14 md:h-14" src={sustainabilityImg} alt="Sustainability" />
                            <h4 className="text-xl md:text-2xl font-bold mb-3 text-[#40545a]">{t("about.values.value_6.heading")}</h4>
                            <p className="text-gray-500 text-sm md:text-base"><strong><em>{t("about.values.value_6.slogan")}<br /></em></strong>{t("about.values.value_6.desc")}</p>
                        </div>
                    </div>
                </div>
            </section>
            <section className="flex flex-col p-6 mt-6">
                <div className="container mx-auto">
                    <div className="text-center pt-6 mb-12">
                        ...
                        <h2 className="text-4xl font-bold text-[#40545a]">{t("about.who")}</h2>
                        <div className="mt-2 flex justify-center">
            ...
            <section className="p-6 mb-12">
                <div className="container mx-auto">
                    <div className="text-center pt-6 mb-12">
                        ...
                        <h2 className="text-4xl font-bold text-[#40545a]">{t("about.what")}</h2>
                        <div className="mt-2 flex justify-center">
                            <hr aria-hidden="true" role="separator" className="border-t-2 border-gray-300 w-[60px]" />
                        </div>
                    </div>
