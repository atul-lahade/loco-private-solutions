            ...
            <div className="max-w-screen-xl px-4 py-4 mx-auto space-y-0 overflow-hidden sm:px-6 lg:px-8">
                <nav className="flex flex-wrap justify-center -mx-5 -my-2">
                    <div className="px-5 py-2">
                        <NavLink to="/about-us">
                            <span className="text-base leading-6 text-gray-500 hover:text-white">
                                About Us
                            </span>
                        </NavLink>
                    </div>
                ...
                <div className="bg-black w-full h-auto py-8 flex items-center justify-center gap-4 flex-wrap">
                    <NavLink
