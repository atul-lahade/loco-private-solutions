import ayurvedImg from '../assets/images/ayurved-consultancy.webp';
import businessImg from '../assets/images/business-consultancy.webp';
import educationImg from '../assets/images/education.webp';
import itImg from '../assets/images/it-consulting.webp';
import marketImg from '../assets/images/market-research.webp';
                                ...
                                <div className="relative">
                                    <div className="group-hover:bg-[#799AA3] text-center w-72 lg:w-96 px-4 lg:px-5 py-7 lg:py-10 group-hover:text-white text-black bg-white shadow-xl rounded-b-2xl transition duration-300 ease-in-out">
                                        <div className="relative inline-block">
                                            <h2 className="text-xl md:text-2xl font-bold before:absolute before:w-4 before:h-0.5 group-hover:before:w-full before:transition-all before:bg-white before:bottom-0 before:duration-500 before:ease-in-out inline-block">Marketing Research Reports
                                            </h2>
                                        </div>
