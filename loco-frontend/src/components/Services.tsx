                  ...
                  <div className="relative">
                    <div className="group-hover:bg-gradient-to-r group-hover:from-gray-600 group-hover:via-gray-500 group-hover:to-gray-400 text-center w-72 lg:w-96 px-4 lg:px-5 py-7 lg:py-10 group-hover:text-white text-black bg-white shadow-xl rounded-b-2xl transition duration-300 ease-in-out">
                      <div className="relative inline-block">
                        <h2
                          className="text-xl md:text-2xl font-bold before:absolute before:w-4 before:h-0.5 group-hover:before:w-full before:transition-all 
                                            before:bg-white before:bottom-0 before:duration-500 before:ease-in-out inline-block"
                        >
                          {t("services.service_1.heading")}
                        </h2>
                      </div>
                      <p className="text-sm md:text-base pt-5">
                        {t("services.service_1.desc")}
                      </p>
                    </div>
                  </div>
                </div>
              ...
              <div className="relative cursor-pointer group">
                ...
                <div className="absolute -bottom-32 md:-bottom-40 lg:-bottom-32 left-2/4 -translate-x-1/2">
                  <div className="relative">
                    <div className="group-hover:bg-gradient-to-r group-hover:from-gray-600 group-hover:via-gray-500 group-hover:to-gray-400 text-center w-72 lg:w-96 px-4 lg:px-5 py-7 lg:py-10 group-hover:text-white text-black bg-white shadow-xl rounded-b-2xl transition duration-300 ease-in-out">
                      <div className="relative inline-block">
                        <h2 className="text-xl md:text-2xl font-bold before:absolute before:w-4 before:h-0.5 group-hover:before:w-full before:transition-all before:bg-white before:bottom-0 before:duration-500 before:ease-in-out inline-block">
                          {t("services.service_2.heading")}
                        </h2>
                      </div>
                      <p className="text-sm md:text-base pt-5">
                        {t("services.service_2.desc")}
                      </p>
                    </div>
                  </div>
                </div>
