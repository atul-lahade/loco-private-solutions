    ...
    <>
      <footer className="flex flex-col space-y-3 z-50 justify-center border-t border-slate-900/5 py-4 bg-gradient-to-r from-gray-900 via-gray-800 to-gray-700">
        <nav className="flex justify-center flex-wrap gap-6 text-white font-medium">
          <a
            className="hover:text-orange-300 transition delay-100 duration-100 ease-in-out hover:scale-110"
            href={homeRoute}
          >
            {t("navbar.home")}
          </a>
        ...
        <div className="flex justify-center space-x-5">
          <a
            href="https://facebook.com/478340502036431"
            id="facebook"
            target="_blank"
          ...
          <a
            href="https://instagram.com/locoprivatesolutions/"
            id="instagram"
            target="_blank"
            rel="noopener noreferrer"
          >
          ...
          >
            <img
              className="transition-transform duration-300 transform hover:scale-125"
              src="https://img.icons8.com/fluent/30/000000/gmail.png"
            />
          </a>
        </div>
        <p className="text-center text-gray-400 font-medium">
          Copyright © 2025 Loco Private Solutions - All Rights Reserved.
        </p>
      </footer>
    </>
  );
