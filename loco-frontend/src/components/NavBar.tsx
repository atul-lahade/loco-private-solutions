  ...
  return (
    <>
      <nav className="bg-black shadow-md fixed w-full top-0 z-50 mb-4">
        <div className="max-w-7xl mx-auto px-6 md:px-4 lg:px-24">
          <div className="flex justify-between h-20 md:gap-4 lg:gap-16">
            <div
              className="flex-shrink-0 flex items-center md:px-8"
            ...
            <div className="hidden lg:flex items-center space-x-4">
              ...
              <details className="group relative">
                ...
                <ul
                  id="menu"
                  className="absolute left-0 w-40 bg-white shadow-lg opacity-0 invisible group-open:opacity-100 group-open:visible transition duration-300 space-y-2 rounded-xl"
                >
                  <li>
                    <NavLink
                      to={marketingRoute}
              ...
              <NavLink
                ...
                className={`${
                  activeLink === t("navbar.testimonials")
                    ? "text-orange-300"
                    : "text-white"
                } hover:text-orange-300 text-lg tracking-widest transition delay-100 duration-300 ease-in-out hover:scale-110`}
          ...
          <div className="lg:hidden bg-black">
            <div className="px-4 pt-2 pb-3 space-y-1 sm:px-3">
              <NavLink
                to={homeRoute}
                className={`block ${
                  activeLink === "Home" ? "text-orange-300" : "text-white"
              ...
              <NavLink
                to={aboutRoute}
                className={`block ${
                  activeLink === "About" ? "text-orange-300" : "text-white"
                } hover:text-orange-300 text-lg tracking-wider transition delay-100 duration-300 ease-in-out hover:scale-110`}
                ...
                <ul id="menu" className="flex flex-col gap-2 pl-2 mt-1">
                  <li className="flex">
                    <NavLink
                      ...
                      onClick={() =>
                        handleLinkClick(t("services.service_1.heading"))
                      }
                    >
                      {t("services.service_1.heading")}
                    </NavLink>
                  ...
                  <li className="flex">
                    <NavLink
                      ...
                      onClick={() =>
                        handleLinkClick(t("services.service_2.heading"))
                      }
                    >
                      {t("services.service_2.heading")}
                    </NavLink>
                  ...
                  <li className="flex gap-2">
                    <NavLink
                      ...
                      className="block px-4 py-2 text-base tracking-wider text-white hover:bg-gray-200 hover:cursor-pointer"
                      onClick={() =>
                        handleLinkClick(t("services.service_3.heading"))
                      }
                    >
                      {t("services.service_3.heading")}
                    </NavLink>
                  ...
                  <li className="flex gap-2">
                    <NavLink
                      ...
                      className="block px-4 py-2 text-base tracking-wider text-white hover:bg-gray-200 hover:cursor-pointer"
                      onClick={() =>
                        handleLinkClick(t("services.service_4.heading"))
                      }
                    >
                      {t("services.service_4.heading")}
                    </NavLink>
                  ...
                  <li className="flex gap-2">
                    <NavLink
                      ...
                      className="block px-4 py-2 text-base tracking-wider text-white hover:bg-gray-200 hover:cursor-pointer"
                      onClick={() =>
                        handleLinkClick(t("services.service_5.heading"))
                      }
                    >
                      {t("services.service_5.heading")}
                    </NavLink>
                  ...
                  <li className="flex gap-2">
                    <NavLink
                      ...
                      onClick={() =>
                        handleLinkClick(t("services.service_6.heading"))
                      }
                    >
                      {t("services.service_6.heading")}
                    </NavLink>
              ...
              <NavLink
                to={productsRoute}
                className={`block ${
                  activeLink === "Products" ? "text-orange-300" : "text-white"
                } hover:text-orange-300 text-lg tracking-wider transition delay-100 duration-300 ease-in-out hover:scale-110`}
      ...
      <button
        type="button"
        onClick={scrollToTop}
        className={`fixed bottom-5 end-5 z-50 rounded-full bg-red-600 p-3 text-xs font-medium uppercase leading-tight text-white shadow-md transition duration-150 ease-in-out hover:bg-red-700 hover:shadow-lg focus:bg-red-700 focus:shadow-lg focus:outline-none focus:ring-0 active:bg-red-800 active:shadow-lg ${
